    ...
    <div className="tryouts">
      <Card style={{ backgroundColor: "#6c757d00", borderColor: "#6c757d00", width: '100vw' }}>
        <CardBody>
          ...
          <h3>FIRE FASTPITCH will have tryouts for the teams in age 10U, 12U, 14U and 16U divisions on </h3> <br />

          <h1>Wednesday Aug. 5th from 6-8 PM</h1>
          <h1>and</h1>
          <h1>Saturday August 15th from 10-12 AM</h1> 
          <h3>These are for all age groups. Please arrive half an hour early</h3>
          {/* <h3>REGISTRATION:</h3>  */}
