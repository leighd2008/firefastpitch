    ...
    <div className="tryouts">
      <Card style={{ backgroundColor: "#6c757d00", borderColor: "#6c757d00" }}>
        <CardBody>
          ...
          <h3>FIRE FASTPITCH will have open try outs for the teams in age 10U, 12U, 14U and 16U divisions on </h3> <br/> <h2>Saturday August 1st</h2> 
          <br />
          ...
          <br />
          <h2>*PITCHERS & CATCHERS</h2> <h3> will need to possibly stay an additioinal 30 min to be evaluated separately</h3>
          <br/>
          <h2>LOCATION:</h2><h3>800 Gillmer Rd <br /> Leavittsbug Ohio 44430</h3>
          <br />

            <h2>REGISTRATION:</h2> <h3>Will be at Field #1. Info sheet and questionaire will need filled out before evaluations.</h3>
          <br />
          <h2>Wednesday Aug. 5th from 6-8 PM</h2>
          ...
          <br />
            ...
            <h3>If you or anyone you know is interested in discussing a coaching opportunity or would like to get a private tryout for your daughter please contact us here by PM or eamil at: </h3>
